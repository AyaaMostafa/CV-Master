      ...
      <div className="cv-content-container">
        ...
        <div className="experience-section">
          ...
          <div className="experience-item">
            <img src="Rectangle 55.png" alt="Degree" className="experience-image" />
            <div className="experience-details">
              <div className="experience-role">PHP Nano Degree Program Certifcate</div>
              <div className="experience-company">Udacity</div>
              <div className="experience-duration">Issued Mar 2021 . No Expiration Date</div>
              <div className="experience-location-button">
              <img src="Group 8560.png" alt="Icon" className="experience-icon" />
                Show credential
                </div>
            </div>
          </div>
